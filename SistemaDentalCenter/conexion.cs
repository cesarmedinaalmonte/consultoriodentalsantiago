...
namespace SistemaDentalCenter
{
    public class conexion
    {
        ...
        private string cadena = "Data Source=C:\\DB\\ConsultorioDental.sqlite";//Esta es la variable que contiene la direccion de la conexion a la base de datos
        ...
        // este metodo es para consultar la base de datos y devolver un resultado, es decir para un SELECT
